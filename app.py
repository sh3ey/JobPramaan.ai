...
st.markdown("""
    ...
    /* Mac Dots & Tabs Header (Updated to remove fake URL/Screenshot tabs) */
...
with col2:
    # Removed the fake URL and Screenshot tabs here
    st.markdown('''
...
# 4. Spacing to separate sections
st.markdown("<br><br><hr style='border-color: #1a2621;'><br>", unsafe_allow_html=True)

# 5. Bottom Information Cards (Guide, Tips, Facts)
        ...
        <div class="info-card">
            ...
            <div class="info-text">
                ...
                <ul>
                    ...
                    <li><b>Scan:</b> Click 'Scan Now' to let our Machine Learning model analyze the syntax.</li>
    ...
    st.markdown('''
        <div class="info-card">
            ...
            <div class="info-text">
                ...
                <ul>
                    <li><b>Check the Email:</b> Legitimate recruiters rarely use <code>@gmail.com</code>. Watch out for misspelled domains (e.g., <code>@amazon-jobs-hr.com</code>).</li>
        ...
        <div class="info-card">
            ...
            <div class="info-text">
                ...
                <ul>
                    ...
                    <li><b>The 'Fake Check' tactic</b> is the most common: scammers send you a check for home office gear and ask you to wire the leftover money back.</li>
                    <li>Our AI flags <b>"Urgency"</b> and <b>"Unrealistic Pay"</b> ($50/hr for basic data entry) as the highest risk factors in text patterns.</li>
                </ul>
            </div>
        </div>
    ''', unsafe_allow_html=True)

st.markdown("<br><p style='text-align: center; color: #4b5563; font-size: 13px;'>Powered by Scikit-Learn • NLP TF-IDF • Made for Educational Purposes</p>", unsafe_allow_html=True)