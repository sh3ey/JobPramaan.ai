...
Logistic Regression: Great baseline, balanced weights handled the imbalanced classes well.
Multinomial Naive Bayes: Traditionally strong for text classification but struggled slightly with minority class recall.
Linear SVM: Achieved the best balance of Precision and Recall for the TF-IDF feature space.
Random Forest: Strong ensemble performance, though computationally heavier.
...
Developed as part of an Internship Project, focusing on Applied Machine Learning, NLP Pipeline Engineering, and Interactive Software Deployment.
